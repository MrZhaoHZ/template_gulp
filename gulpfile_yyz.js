...
gulp.task('view2html', function() {
	...
	switch(gulp_param) {
		case "test":
			...
			static_path_1 = '//wxtest.yyzws.com';
			static_path_2 = '//wxtest.yyzws.com';
			break;
		case "lt":
			//static_path_1 = '//192.168.8.143:3000';
		...
		case "pro":
			...
			break;
		default:
			static_path_1 = '//192.168.8.145:3000';
			static_path_2 = '//192.168.8.145:3000';
	}
