...
gulp.task('view2html', function() {
	...
	switch(gulp_param) {
		case "test":
			...
			static_path_1 = '//dltest1.yyzws.com/dl_gateway_web/static';
			static_path_2 = '//dltest1.yyzws.com/dl_gateway_web/static';
			break;
		case "pre":
		...
		case "pro":
			...
			break;
		default:
			static_path_1 = '//192.168.1.68:3000';
			static_path_2 = '//192.168.1.68:3000';
	}
...
gulp.task('webpack',function(){
	...
	switch(gulp_param) {
		case "test":
			pathConfig('module.exports = {\n\t"api_path_1": "http://dltest1.yyzws.com/dl_gateway_web",\
				\n\t"api_path_actDra": "http://yiyezi.yyzws.com/qr/",\
				\n\t"api_path_actDra_ex": "http://yiyezi.yyzws.com/ex/",\
				...
				\n\t"api_path_act": "http://dltest1.yyzws.com/dl_gateway_web",\
				\n\t"api_path_act_http": "dltest1.yyzws.com",\
				\n\t"static_path": "http://statictest1.yyzws.com",\
				\n\t"upload_path": "http://img.yyzws.com/ex/",\
				\n\t"upload_path_h5": "http://img.yyzws.com/in/",\
				\n\t"wxdomain": "dltest1.yyzws.com",\
				\n\t"appid": "wx00945b8865c0f39e",\
				\n\t"secret": "aa13e115a9bbcf1bc52ec56\797c1e555",\
