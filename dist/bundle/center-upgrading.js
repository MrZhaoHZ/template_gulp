...
/***/ (function(module, exports, __webpack_require__) {
	...
	$(function(){
		...
		__webpack_require__(29).redirectByStatusIfUpGrading();
		// }
		//发展代理链接
		...
		function setPersonalInfo(pramData){
			...
			developAgentLink = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + api_path_config.appid + '&redirect_uri=http%3A%2F%2F' + api_path_config.wxdomain + '%2Fwechat_web%2Fwechat%2FwxAutho.do%3Fredirect_url%3Dhttp%253A%252F%252F' + api_path_config.wxdomain + '%252Fhtml%252Fdele-register.html%26up_id%3D' + __webpack_require__(30).encode(data.data.member_id) + '&response_type=code&scope=snsapi_userinfo';
		...
		function getShareLink() {
			var shareLink = null;
			shareLink = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + api_path_config.appid + '&redirect_uri=https%3A%2F%2F' + api_path_config.wxdomain+ '%2Fwechat_web%2Fwechat%2FwxAutho.do%3Fredirect_url%3Dhttps%253A%252F%252F' + api_path_config.wxdomain+ '%252Fhtml%252Fdele-register.html%26up_id%3Dnull&response_type=code&scope=snsapi_userinfo';
			if(allowShare){
